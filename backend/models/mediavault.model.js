...
const mediaVaultSchema = new mongoose.Schema({
  ...
  image: { type: Buffer, required: true, set: encrypt, get: decrypt },
  video: { type: Buffer, required: true, set: encrypt, get: decrypt },
  audio: { type: Buffer, required: true, set: encrypt, get: decrypt }
});
